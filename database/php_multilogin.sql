...
--
CREATE DATABASE IF NOT EXISTS `php_multiplelogin` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `php_multilogin`;
...
CREATE TABLE `mainlogin` (
  ...
  `pasword` varchar(20) CHARACTER SET latin1 NOT NULL,
...
INSERT INTO `mainlogin` (`id`, `username`, `email`, `pasword`, `role`) VALUES
(1, 'ramon', 'ramon@gmail.com', '123456', 'admin'),
(2, 'lucas', 'hincha.de.river@gmail.com', '654321', 'personal');
